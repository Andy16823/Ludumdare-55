...
namespace Summoning.Navigation
{
    ...
    /// <summary>
    /// Represents a navigation mesh for pathfinding on a grid-based map.
    /// </summary>
    public class NavMesh
    {
        ...
        public NavMesh(Vec3 location, int cellsX, int cellsY, float cellSize)
        {
        ...
        {
            var x = Math.Abs(col - eCol);
            var y = Math.Abs(row - eRow);
